...
class WhooshParameter:
    tableNameList = ["meta_project", "meta_questionnaire", "meta_variable"]
    dataBaseList = ["db_metadata", "db_metadata", "db_metadata"]
    uniqueValueList = ["ProjectID", "QuestID", "VariableID"]
